...
class _StatusScreenState extends State<StatusScreen>
      ...
      child: Scaffold(
        body: ValueListenableBuilder(
            ...
            builder: (context, dataState, child) {
              ...
              } else if (dataState.data!.isNotEmpty && dataState.data != null) {
                return CardSwiper(
                    cardsCount: cnnctProvider.value.data!.length,
                    cardBuilder:
                        (context, index, percentThresholdX, percentThresholdY) {
                      if (cnnctProvider.value.data != null &&
                          index < cnnctProvider.value.data!.length) {
                        var mediaList = cnnctProvider.value.data![index].media;
                        return Stack(
                          ...
                          children: [
                            ...
                            Positioned(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    cnnctProvider.value.data!.isNotEmpty
                                        ? CircleAvatar(
                                            child: Image.network(
                                              mediaList.isEmpty
                                                  ? ''
  ...
  void _updateStatus({required bool forward}) {
    setState(() {
      if (forward) {
        if (_currentIndex < cnnctProvider.value.data!.length) {
          _currentIndex++;
        } else {
