import 'package:_2geda/pages/stereoPages/uploadMusic/single/recent_uploads.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/material.dart';

class SingleDetailUpload extends StatefulWidget {
  const SingleDetailUpload({super.key});

  @override
  State<SingleDetailUpload> createState() => _SingleDetailUploadState();
}

class _SingleDetailUploadState extends State<SingleDetailUpload> {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const RecentUpload(), // Replace with the actual screen
                      ),
                    );
                  },
