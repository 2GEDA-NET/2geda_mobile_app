...
class BigHitMusicList extends StatefulWidget {
  const BigHitMusicList({Key? key}) : super(key: key);

  @override
  _BigHitMusicListState createState() => _BigHitMusicListState();
}

class _BigHitMusicListState extends State<BigHitMusicList> {
  String? authToken;
  ...
  Future<void> fetchData() async {
    try {
      ...
      final List<AudioModel> audioModels = await stereoApiService.fetchbigHitSongAudioList(authToken!);
